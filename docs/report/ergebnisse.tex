...
Unser bester Klassifikator 2018-03-10\_19-16-32 wurde also mit einer Batchsize von sechs sowie einer Lernrate von $e^{-6}$ trainiert. Als Loss-Funktion verwendeten wir das L2-Loss. Als Entscheidungsschranke nahmen wir wie oben beschrieben $0.35$, was bedeutet alle Beispiele die einen Score von über $0.35$ erhalten werden als maligne Hautläsion eingestuft. Schließlich testeten unseren finalen Prädiktor noch auf unserem Testdatensatz. Dieser Datensatz wurde bis an diese stelle isoliert behandelt und keine der enthaltenen Daten waren dem Klassfikator bekannt um zu testen, ob dieser auch Generalisierbar ist und nicht nur die Trainingsdaten auswendig gelernt hat. Da wir anhand des Validierungs-Datensatzes die Trainingsparameter angepasst haben, wurde dieser Test-Datensatz jetzt am Schluss noch einmal verwendet um die endgültige Performance zu testen. Tabelle~~\ref{tab:test_scores} zeigt die Qulitätsmaßstäbe wie sie auf dem finalen Testdatensatz berechnet wurden.
...
\begin{tabular}{lllllllllll}
	...
	\midrule
    $142$&	$91$ &	$2406$ &	$114$ &	$0.54$ 	&$0.60$	&$0.93$	&$0.61$&	$0.95$ \\
 \bottomrule
 \end{tabular}
 \end{center}
  \caption{Scores des Klassifikators mit dem Threshold bei $0.35$}
